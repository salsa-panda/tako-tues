...
### 2.2 Week 1: 強制ループ本番（v1.1 - 材料受け取り + レシピ + 24h カウントダウン統合）
...
**v1.1 追加ポイント**:
- 月曜 21:00: **材料受領 + Bedrock レシピ配信**（US-T13） → 受動的に料理させられる
...
20:00  カウントダウン残り 1 時間 Push
       ...
       → タロウ: 仕方なく台所へ向かう。Bedrock レシピを開く（US-T13）
...
### Bonus #4 (v1.1 追加): 24h カウントダウン + Bedrock レシピ表示（US-T13/T14）
- 月曜夜の材料受領 → アミーゴ口調レシピが Push → カウントダウンが秒単位で減る
- **インパクト**: 「**タコスが生活の一部になる**」のコアコンセプトを最も雄弁に示す瞬間
- **デモ手順**: 時計を月曜 21:00 に進める → ダッシュボードでカウントダウン起動を見せる
- **ハッカソン審査基準への適合**: 「Bedrock 活用」「AI-DLC プロセス成果」「テーマ適合性」の 3 つを同時に体感させられる
...
| 5-7 分 | デモ #2: 月曜夜 — 材料受領 + Bedrock レシピ + 24h カウントダウン（US-T13/T14） |
