...
- 2026-05-09 v2.0: **stories v2.0 対応** — US-T15（文化的受容・Taco Tuesday 生活定着）を U7 PwaFrontend に追加。ストーリー総数 15 → 16 に更新。タロウ 11 → 12 件。§4 / §6 の参照バージョンを v1.3→v2.0 に更新。
...
stories.md v2.0 の 16 ストーリー（タロウ 12 + ミナミ 4。v1.1 で US-T11 / US-M03 削除済み、v2.0 で US-T15「文化的受容」追加）を、**主担当 Unit と関与 Unit に分けてマッピング**する。
...
**合計**: 16 ストーリー（v2.0 時点、US-T15「文化的受容」追加。US-T05 は v1.1 で US-T13 に統合済み、US-T11 / US-M03 は v1.4 で削除）
...
- **関与（UI レイヤー）**: 全 16 ストーリー（PWA は全機能の入り口。v1.1 で US-T11 / US-M03 削除、v2.0 で US-T15 追加を反映）
